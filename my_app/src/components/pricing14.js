        ...
        <div className="pricing14-section-title">
          <div className="pricing14-content">
            <h2 className="pricing14-text100 thq-heading-2">
              {props.heading1 ?? (
                <Fragment>
                  <span className="pricing14-text211">Pricing plan</span>
                </Fragment>
              )}
            </h2>
          </div>
            ...
            <div className="pricing14-column1 thq-card">
              <div className="pricing14-price10">
                <div className="pricing14-price11">
                  ...
                  <h3 className="pricing14-text105 thq-heading-3">
                    {props.plan1Price ?? (
                      <Fragment>
                        <span className="pricing14-text159">$20/mo</span>
                      </Fragment>
                    )}
                  </h3>
              ...
              <button className="pricing14-button3 thq-button-outline thq-button-animated">
                <span className="thq-body-small">
                  {props.plan1Action ?? (
                    <Fragment>
                      <span className="pricing14-text210">Get started</span>
                    </Fragment>
                  )}
                </span>
              </button>
              ...
              <div className="pricing14-price12">
                <div className="pricing14-price13">
                  ...
                  <h3 className="pricing14-text113 thq-heading-3">
                    {props.plan2Price ?? (
                      <Fragment>
                        <span className="pricing14-text194">$29/mo</span>
                      </Fragment>
                    )}
                  </h3>
                  <p className="thq-body-large">
            ...
            <div className="pricing14-column4 thq-card">
              <div className="pricing14-price16">
                <div className="pricing14-price17">
                  <span className="pricing14-text133 thq-body-large">
                    {props.plan11 ?? (
                      <Fragment>
                  ...
                  <h3 className="pricing14-text134 thq-heading-3">
                    {props.plan1Price1 ?? (
                      <Fragment>
            ...
            <div className="pricing14-column5 thq-card">
              <div className="pricing14-price18">
                <div className="pricing14-price19">
                  <span className="pricing14-text140 thq-body-large">
                    {props.plan21 ?? (
                      <Fragment>
                  ...
                  <h3 className="pricing14-text141 thq-heading-3">
                    {props.plan2Price1 ?? (
                      <Fragment>
                        <span className="pricing14-text158">$299/yr</span>
                      </Fragment>
                    )}
                  </h3>
                  <span className="thq-body-large">
            ...
            <div className="pricing14-column6 thq-card">
              <div className="pricing14-price20">
                <div className="pricing14-price21">
                  <span className="pricing14-text148 thq-body-large">
                    {props.plan31 ?? (
                      <Fragment>
                  ...
                  <h3 className="pricing14-text149 thq-heading-3">
                    {props.plan3Price1 ?? (
                      <Fragment>
                        <span className="pricing14-text161">$499/yr</span>
                      </Fragment>
                    )}
                  </h3>
                  <span className="thq-body-large">
...
Pricing14.propTypes = {
  ...
  plan2Feature422: PropTypes.element,
