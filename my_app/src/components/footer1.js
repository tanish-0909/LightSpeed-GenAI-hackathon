          ...
          <div className="footer1-links">
            <div className="footer1-column1">
              <strong className="thq-body-large footer1-column1-title">
                {props.column1Title ?? (
                  <Fragment>
                    <span className="footer1-text22">Company</span>
                  </Fragment>
                )}
              </strong>
              <div className="footer1-footer-links1">
                ...
                >
                  {props.link1 ?? (
                    <Fragment>
                      <span className="footer1-text28">About Us</span>
                    </Fragment>
                  )}
                </a>
                <a
                ...
                >
                  {props.link3 ?? (
                    <Fragment>
                      <span className="footer1-text18">FAQs</span>
                    </Fragment>
                  )}
                </a>
                <a
                ...
                >
                  {props.link5 ?? (
                    <Fragment>
                      <span className="footer1-text17">Logo Generator</span>
                    </Fragment>
                  )}
                </a>
              </div>
            ...
            <div className="footer1-column2">
              <strong className="thq-body-large footer1-column2-title">
                {props.column2Title ?? (
                  <Fragment>
                    <span className="footer1-text23">Services</span>
                  </Fragment>
                )}
              </strong>
              <div className="footer1-footer-links2">
                ...
                >
                  {props.link6 ?? (
                    <Fragment>
                      <span className="footer1-text16">Video Generator</span>
                    </Fragment>
                  )}
                </a>
                <a
                ...
                >
                  {props.link7 ?? (
                    <Fragment>
                      <span className="footer1-text25">Post Generator</span>
                    </Fragment>
                  )}
                </a>
                <a
                ...
                >
                  {props.link9 ?? (
                    <Fragment>
                      <span className="footer1-text14">Pricing Plans</span>
                    </Fragment>
                  )}
                </a>
                <a
                ...
                >
                  {props.link10 ?? (
                    <Fragment>
                      <span className="footer1-text24">Consultation</span>
                    </Fragment>
                  )}
                </a>
              </div>
            ...
            <div className="footer1-column3">
              <strong className="thq-body-large footer1-social-link1-title">
                {props.socialLinkTitleCategory ?? (
                  <Fragment>
                    <span className="footer1-text11">Connect with Us</span>
                  </Fragment>
                )}
              </strong>
          ...
          <div className="footer1-row">
              ...
              {props.content3 ?? (
                <Fragment>
                  <span className="footer1-text13">
                    Designed by AI Digital Marketing Firm
                  </span>
                </Fragment>
              )}
            </span>
            <div className="footer1-footer-links3">
              ...
              <span className="thq-body-small">
                {props.cookiesLink ?? (
                  <Fragment>
                    <span className="footer1-text21">/cookie-policy</span>
                  </Fragment>
                )}
              </span>
            </div>
